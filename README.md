...
:--- | ---: | ---:
Kernel, dtbs, modules and (kernel) firmware | 4.19.60.20190730 | [bcmrpi3-kernel-4.19.60.20190730.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.19.60.20190730/bcmrpi3-kernel-4.19.60.20190730.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.19.60.20190730/bcmrpi3-kernel-4.19.60.20190730.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-4.19.60.20190730.tar.xz -C /
pi64 ~ # sync && reboot
```
