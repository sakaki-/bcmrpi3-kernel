...
:--- | ---: | ---:
Kernel, dtbs, modules and (kernel) firmware | 5.4.44.20200607 | [bcmrpi3-kernel-5.4.44.20200607.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel/releases/download/5.4.44.20200607/bcmrpi3-kernel-5.4.44.20200607.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel/releases/download/5.4.44.20200607/bcmrpi3-kernel-5.4.44.20200607.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-5.4.44.20200607.tar.xz -C /
pi64 ~ # sync && reboot
```
