...
:--- | ---: | ---:
Kernel, dtbs, modules and (kernel) firmware | 4.14.95.20190129 | [bcmrpi3-kernel-4.14.95.20190129.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.95.20190129/bcmrpi3-kernel-4.14.95.20190129.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.95.20190129/bcmrpi3-kernel-4.14.95.20190129.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-4.14.95.20190129.tar.xz -C /
pi64 ~ # sync && reboot
```
