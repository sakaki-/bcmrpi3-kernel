...
:--- | ---: | ---:
Kernel, dtbs, modules and (kernel) firmware | 4.14.29.20180326 | [bcmrpi3-kernel-4.14.29.20180326.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.29.20180326/bcmrpi3-kernel-4.14.29.20180326.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.29.20180326/bcmrpi3-kernel-4.14.29.20180326.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-4.14.29.20180326.tar.xz -C /
pi64 ~ # sync && reboot
```
