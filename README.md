...
:--- | ---: | ---:
Kernel, dtbs, modules and (kernel) firmware | 4.14.61.20180814 | [bcmrpi3-kernel-4.14.61.20180814.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.61.20180814/bcmrpi3-kernel-4.14.61.20180814.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel/releases/download/4.14.61.20180814/bcmrpi3-kernel-4.14.61.20180814.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-4.14.61.20180814.tar.xz -C /
pi64 ~ # sync && reboot
```
